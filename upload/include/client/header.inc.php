...
<div id="container">
    ...
    <ul id="nav">
         ...
         <li><a class="my_tickets" href="tickets.php">Miei Ticket</a></li>
         <?}else {?>
         <li><a class="ticket_status" href="tickets.php">Status dei Ticket</a></li>
         <?}?>
         <li><a class="new_ticket" href="open.php">Nuovo Ticket</a></li>
